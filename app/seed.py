...
RAJATOPUP_EXTRA_CATALOG = [
    ...
    },
    {
        ...
        "categories": [
            {"name": "Favorite Sosmed", "badge": "SOSMED", "icon": "sosmed-favorite.png", "products": [("Paket Rekomendasi Sosmed", 10000), ("Paket Terlaris Sosmed", 25000), ("Paket Campuran Sosmed", 50000)]},
            {"name": "Facebook Sosmed", "badge": "SOSMED", "icon": "sosmed-facebook.png", "products": [("1K Facebook Followers", 30000), ("3K Facebook Followers", 65000), ("5K Facebook Followers", 95000), ("1K Facebook Likes", 30000), ("1K Facebook Views", 20000)]},
            {"name": "Instagram Sosmed", "badge": "SOSMED", "icon": "sosmed-instagram.png", "products": [("1K Instagram Followers", 85000), ("3K Instagram Followers", 185000), ("5K Instagram Followers", 255000), ("1K Instagram Likes", 35000), ("3K Instagram Likes", 65000), ("5K Instagram Likes", 85000)]},
            {"name": "TikTok Sosmed", "badge": "SOSMED", "icon": "sosmed-tiktok.png", "products": [("1K TikTok Followers", 95000), ("2K TikTok Followers", 180000), ("3K TikTok Followers", 250000), ("1K TikTok Likes", 25000), ("3K TikTok Likes", 45000), ("5K TikTok Likes", 85000), ("10K TikTok Views", 30000)]},
            {"name": "Promo Sosmed", "badge": "PROMO", "icon": "sosmed-promo.png", "products": [("Promo Followers", 10000), ("Promo Likes", 10000), ("Promo Views", 10000)]},
            {"name": "Binance Sosmed", "badge": "SOSMED", "icon": "sosmed-binance.png", "products": [("Binance Engagement", 10000), ("Binance Traffic", 25000)]},
            {"name": "GitHub Sosmed", "badge": "SOSMED", "icon": "sosmed-github.png", "products": [("GitHub Stars", 10000), ("GitHub Followers", 15000), ("GitHub Forks", 20000)]},
            {"name": "Kick Sosmed", "badge": "SOSMED", "icon": "sosmed-kick.png", "products": [("Kick Followers", 15000), ("Kick Views", 20000)]},
            {"name": "Bigo Sosmed", "badge": "SOSMED", "icon": "sosmed-bigo.png", "products": [("Bigo Followers", 15000), ("Bigo Views", 20000)]},
            {"name": "CapCut Sosmed", "badge": "SOSMED", "icon": "sosmed-capcut.png", "products": [("CapCut Followers", 15000), ("CapCut Likes", 15000), ("CapCut Views", 20000)]},
            {"name": "WhatsApp Sosmed", "badge": "SOSMED", "icon": "sosmed-whatsapp.png", "products": [("WhatsApp Channel Followers", 20000), ("WhatsApp Group Member", 25000)]},
            {"name": "Google Sosmed", "badge": "SOSMED", "icon": "sosmed-google.png", "products": [("Google Review", 25000), ("Google Maps Rating", 25000)]},
            {"name": "Twitter / X Sosmed", "badge": "SOSMED", "icon": "sosmed-twitter.png", "products": [("Twitter/X Followers", 15000), ("Twitter/X Likes", 15000), ("Twitter/X Retweet", 15000)]},
            {"name": "YouTube Sosmed", "badge": "SOSMED", "icon": "sosmed-youtube.png", "products": [("YouTube Subscribers", 20000), ("YouTube Likes", 15000), ("YouTube Views", 20000), ("YouTube Watch Hours", 50000)]},
            {"name": "Telegram Sosmed", "badge": "SOSMED", "icon": "sosmed-telegram.png", "products": [("1K Telegram Followers", 65000), ("3K Telegram Followers", 135000), ("5K Telegram Followers", 215000), ("Telegram Channel Member", 20000), ("Telegram Post Views", 15000)]},
            {"name": "Threads Sosmed", "badge": "SOSMED", "icon": "sosmed-threads.png", "products": [("Threads Followers", 15000), ("Threads Likes", 15000)]},
            {"name": "Traffic Website", "badge": "TRAFFIC", "icon": "sosmed-traffic.png", "products": [("Traffic Website Indonesia", 25000), ("Traffic Website Global", 30000), ("SEO Traffic", 50000)]},
            {"name": "Discord Sosmed", "badge": "SOSMED", "icon": "sosmed-discord.png", "products": [("Discord Member", 20000), ("Discord Online Member", 30000)]},
            {"name": "LinkedIn Sosmed", "badge": "SOSMED", "icon": "sosmed-linkedin.png", "products": [("LinkedIn Followers", 20000), ("LinkedIn Likes", 15000), ("LinkedIn Connections", 25000)]},
            {"name": "Spotify Sosmed", "badge": "SOSMED", "icon": "sosmed-spotify.png", "products": [("Spotify Plays", 15000), ("Spotify Followers", 20000), ("Spotify Saves", 15000)]},
            {"name": "Shopee Sosmed", "badge": "SOSMED", "icon": "sosmed-shopee.png", "products": [("Shopee Followers", 15000), ("Shopee Likes", 15000), ("Shopee Product Views", 20000)]},
        ],
    },
    {
